...
BATCH_SIZE = 64
N_CLASSES = 10
model_filename = "results_vgg_original_experiment_cities_dropout2/cities_vgg16-{epoch:02d}-{val_acc:.3f}.hdf5"
...
plt.savefig("results_vgg_original_experiment_cities_dropout2/results_vgg_original_experiment_cities.jpg")