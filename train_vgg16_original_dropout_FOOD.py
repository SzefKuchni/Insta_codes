...
BATCH_SIZE = 64
N_CLASSES = 10
model_filename = "results_vgg_original_experiment_food_dropout5_trainable_layers_change/food_vgg16-{epoch:02d}-{val_acc:.3f}.hdf5"
...
#model.load_weights("results_vgg_original_experiment_food_dropout/food_vgg16-32-0.436.hdf5")
# set all layers trainable by default
for layer in model.layers:
    layer.trainable = True
    
# fix deep layers (fine-tuning only last 3)
...
plt.savefig("results_vgg_original_experiment_food_dropout5_trainable_layers_change/results_vgg_original_experiment_FOOD.jpg")