...
directory = '../../PascalVOC_INSTA/boat/'
...
num_2_query_first = 300000 #Num of images to build the looter the first time (will downlaod old images)
num_2_query_next = 300000 #Num of images to build the looter affter (will download new updated images)
num_2_download = 300000 #Num of images we want to end up having
