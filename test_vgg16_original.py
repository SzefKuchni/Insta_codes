BATCH_SIZE = 100
N_CLASSES = 10
weights_path = "results_vgg_original/cities_vgg16-08-0.240.hdf5"
...
val_proba = model.predict_generator(val, steps=500, verbose=1)
...
results_val.to_csv("results_vgg_original/cities_vgg16_original.csv", index=False)