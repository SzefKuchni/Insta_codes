...
BATCH_SIZE = 64
N_CLASSES = 10
model_filename = "results_Inception_V3_FOOD/food_InceptionV3-{epoch:02d}-{val_acc:.3f}.hdf5"
...
plt.savefig("results_Inception_V3_FOOD/results_vgg_original_experiment_FOOD.jpg")
...
model_filename_2 = "results_Inception_V3_FOOD_fine_tune/food_InceptionV3-{epoch:02d}-{val_acc:.3f}.hdf5"
checkpointer = ModelCheckpoint(filepath=model_filename_2, verbose=1, save_best_only=True)
...
plt.xlabel('epoch')
plt.legend(['train', 'val'], loc='upper left')
plt.savefig("results_Inception_V3_FOOD_fine_tune/results_vgg_original_experiment_FOOD.jpg")