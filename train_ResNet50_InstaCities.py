...
BATCH_SIZE = 64
N_CLASSES = 10
model_filename = "results_ResNet50_InstaCities_3/InstaCities_ResNet50-{epoch:02d}-{val_acc:.3f}.hdf5"
...
plt.savefig("results_ResNet50_InstaCities_3/results_vgg_original_experiment_FOOD.jpg")

pickle.dump(history, open("results_ResNet50_InstaCities_3/history_metrics.p", "wb"))
