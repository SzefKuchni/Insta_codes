...
BATCH_SIZE = 64
N_CLASSES = 10
model_filename = "results_vgg_original_experiment_cities_dropout_fine_tune3_varied_LR/LR_06_cities_vgg16-{epoch:02d}-{val_acc:.3f}.hdf5"
...
model = vgg16()
model.load_weights("results_vgg_original_experiment_cities_dropout_fine_tune3_varied_LR/cities_vgg16-29-0.296.hdf5")
...
plt.savefig("results_vgg_original_experiment_cities_dropout_fine_tune3_varied_LR/LR_06_results_vgg_original_experiment_cities.jpg")