...
model_filename = "results_vgg_original_experiment_cities_dropout3_varied_LR/phase1_best.hdf5"
...
plt.savefig("results_vgg_original_experiment_cities_dropout3_varied_LR/results_vgg_original_experiment_cities_LR_1e-4.jpg")

model.load_weights("results_vgg_original_experiment_cities_dropout3_varied_LR/phase1_best.hdf5")
...
model_filename = "results_vgg_original_experiment_cities_dropout3_varied_LR/phase2_best.hdf5"
checkpointer = ModelCheckpoint(filepath=model_filename, verbose=1, save_best_only=True)
...
plt.xlabel('epoch')
plt.legend(['train', 'val'], loc='upper left')
plt.savefig("results_vgg_original_experiment_cities_dropout3_varied_LR/results_vgg_original_experiment_cities_LR_1e-5.jpg")

model.load_weights("results_vgg_original_experiment_cities_dropout3_varied_LR/phase2_best.hdf5")
...
model_filename = "results_vgg_original_experiment_cities_dropout3_varied_LR/phase3_best.hdf5"
checkpointer = ModelCheckpoint(filepath=model_filename, verbose=1, save_best_only=True)
...
plt.xlabel('epoch')
plt.legend(['train', 'val'], loc='upper left')
plt.savefig("results_vgg_original_experiment_cities_dropout3_varied_LR/results_vgg_original_experiment_cities_LR_1e-6.jpg")