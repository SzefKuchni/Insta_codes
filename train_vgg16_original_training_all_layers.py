...
BATCH_SIZE = 64
N_CLASSES = 10
model_filename = "results_vgg_original_experiment_cities_training_all_layers_start_from_best/cities_vgg16-{epoch:02d}-{val_acc:.3f}.hdf5"
...
model = vgg16()
model.load_weights("results_vgg_original_experiment_cities1/cities_vgg16-08-0.238.hdf5")
...
plt.savefig("results_vgg_original_experiment_cities_training_all_layers_start_from_best.jpg")